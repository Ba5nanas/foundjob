const script = `
(() => {
  if (window.__foundjobLandingTableFilter) return;
  window.__foundjobLandingTableFilter = true;

  function findTable(bar) {
    const container = bar.closest("article") || bar.closest("main") || document.body;
  ...
  document.addEventListener("input", (event) => {
    ...
    const bar = target.closest(".fj-filterbar");
